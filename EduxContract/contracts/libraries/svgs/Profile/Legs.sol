...
library Legs {
    ...
    function _getLegColorHex(LegColors legColor) internal pure returns (string memory, string memory) {
        if (legColor == LegColors.GREEN) {
            return (EduxColors.darkGreen, EduxColors.lightGreen);
        } else if (legColor == LegColors.PURPLE) {
            return (EduxColors.darkPurple, EduxColors.lightPurple);
        } else if (legColor == LegColors.BLUE) {
            return (EduxColors.darkBlue, EduxColors.lightBlue);
        } else if (legColor == LegColors.PINK) {
            return (EduxColors.darkPink, EduxColors.lightPink);
        } else if (legColor == LegColors.DARK) {
            return (EduxColors.dark, EduxColors.gray);
        } else if (legColor == LegColors.LIGHT) {
            return (EduxColors.lightGray, EduxColors.white);
        } else if (legColor == LegColors.GOLD) {
            return (EduxColors.baseGold, EduxColors.lightGold);
        } else {
